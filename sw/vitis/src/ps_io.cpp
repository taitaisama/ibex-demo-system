...
#define DSIDE_START_ADDR            0x200000
#define CSR_START_ADDR              0x300000

#define PROG_ADDR_OFFSET            0x00000
#define RST_OFFSET                  0x30008
#define FLUSH_OFFSET                0x30000

#define RVFI_HW_IDX_OFFSET          0x50000
#define RVFI_BASE_ADDR_OFFSET       0x00008
#define RVFI_SW_IDX_OFFSET          0x50008

#define CSR_HW_IDX_OFFSET           0x20000
#define CSR_BASE_ADDR_OFFSET        0x10000
#define CSR_SW_IDX_OFFSET           0x20008

#define DSIDE_HW_IDX_OFFSET         0x40000
#define DSIDE_BASE_ADDR_OFFSET      0x10008
#define DSIDE_SW_IDX_OFFSET         0x40008
...
struct ps_io_ctrl {
  ...
  void start(uint32_t * prog_data, uint32_t size) {
    ...
    xil_printf("setting prog offset %x\r\n", v);
    xil_printf("hello?\r\n");
    prog_base_addr_ptr.out(prog_base_addr.get_abs());
    Xil_DCacheFlushRange(prog_base_addr.get_abs(), 8192);
    Xil_DCacheFlushRange(MEM_BASE_PHYS_ADDR + RVFI_START_ADDR, BUFFER_SIZE);
    Xil_DCacheFlushRange(MEM_BASE_PHYS_ADDR + CSR_START_ADDR, BUFFER_SIZE);
    Xil_DCacheFlushRange(MEM_BASE_PHYS_ADDR + DSIDE_START_ADDR, BUFFER_SIZE);
