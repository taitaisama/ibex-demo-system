...
proc create_root_design { } {
  ...
  set_property -dict [list \
  SRC_RM_MAP./ps_io_0.ps_io {ps_io_inst_0} \
...
{PMC_MIO 26 .. 36}}} \
  ...
  # Create instance: ps_io_0, and set properties
  set ps_io_0 [ create_bd_cell -type container -reference ps_io ps_io_0 ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {ps_io.bd} \
    CONFIG.ACTIVE_SYNTH_BD {ps_io.bd} \
    CONFIG.ENABLE_DFX {0} \
    CONFIG.LIST_SIM_BD {ps_io.bd} \
    CONFIG.LIST_SYNTH_BD {ps_io.bd} \
    CONFIG.LOCK_PROPAGATE {0} \
  ] $ps_io_0


  set_property SELECTED_SIM_MODEL rtl  $ps_io_0
  ...
  # Create instance: csr_axis_data_fifo, and set properties
  set csr_axis_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 csr_axis_data_fifo ]
  ...
  # Create instance: dside_axis_data_fifo, and set properties
  set dside_axis_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 dside_axis_data_fifo ]
  ...
  # Create instance: rvfi_axis_data_fifo, and set properties
  set rvfi_axis_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 rvfi_axis_data_fifo ]
  ...
  connect_bd_intf_net -intf_net versal_cips_0_M_AXI_LPD [get_bd_intf_pins versal_cips_0/M_AXI_LPD] [get_bd_intf_pins ps_io_0/S_AXI]
  ...
  [get_bd_pins dside_axis_data_fifo/s_axis_aclk] \
  ...
  connect_bd_net -net ps_io_0_ps_rstn  [get_bd_pins ps_io_0/ps_rstn] \
  ...
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_LPD] [get_bd_addr_segs ps_io_0/rvfi_idx/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces csr_datamover/Data_S2MM] [get_bd_addr_segs axi_noc_0/S09_AXI/C3_DDR_LOW0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces rvfi_datamover/Data_S2MM] [get_bd_addr_segs axi_noc_0/S08_AXI/C2_DDR_LOW0] -force
...
set_property  ip_repo_paths  [list "$dir_path/rtl/fpga/versal_ip/intf_ip" "$dir_path/build/ips/rvfi_ip" "$dir_path/build/ips/ibex_wrapper_ip" "$dir_path/build/ips/io_wrapper_ip" "$dir_path/rtl/fpga/versal_ip/debug_ip"] [current_project]
update_ip_catalog
create_root_design
